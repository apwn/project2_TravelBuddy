class CountriesController < ApplicationController
  ...
  def show
    ...
    @flickrimg = HTTParty.get "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=ae5c1da80ad14208768b6c79a7de337b&text=#{ @cntryname }&sort=relevance&content_type=1&format=json&nojsoncallback=1"
  end
